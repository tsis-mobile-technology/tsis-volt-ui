    ...
    return {
      ...
      drawColumns: function(svg, axes, data, columnWidth) {
        ...
        colGroup.selectAll("rect").data(function(d) {
          ...
          height: function(d) {
            if (d.value === 0) {
console.log("1:" + -(axes[d.axis + 'Scale'].range()[0]));
              // return ( function() {if(axes[d.axis + 'Scale'].range()[0] < 0) -(axes[d.axis + 'Scale'].range()[0]); else axes[d.axis + 'Scale'].range()[0]; });
              return 32;
            }
console.log("2:" + Math.abs(axes[d.axis + 'Scale'](d.value) - axes[d.axis + 'Scale'](0)));
